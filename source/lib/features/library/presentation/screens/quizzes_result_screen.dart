...
@RoutePage()
class QuizzedResultScreen extends ConsumerStatefulWidget {
  const QuizzedResultScreen({super.key});

  @override
  ConsumerState<QuizzedResultScreen> createState() => _QuizzedResultScreenState();
}

class _QuizzedResultScreenState extends ConsumerState<QuizzedResultScreen> {
  @override
  void initState() {
    super.initState();
  }
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            ...
            AutoRouter.of(context).replace(const QuizzesLearningRoute());
          },
          child: const Text(
            "Restart Quiz",
            style: TextStyle(
